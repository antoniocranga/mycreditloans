...
const Color logoColor = Color(0xff0079EB);
const Color logoColorAccent = Color(0xff64a7ff);
const Color scaffoldBackgroundColor = Color(0xffF8F8F8);
const Color darkTextColor = Color(0xFFB0B0B0);
